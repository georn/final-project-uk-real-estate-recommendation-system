...
def build_model(property_input_shape, user_input_shape):
    ...
    property_branch = Dense(64, kernel_initializer=HeNormal(), kernel_regularizer=l2(0.01))(property_input)
    ...
    user_branch = Dense(32, kernel_initializer=HeNormal(), kernel_regularizer=l2(0.01))(user_input)
    ...
    x = Dense(128, kernel_initializer=HeNormal(), kernel_regularizer=l2(0.01))(combined)
    x = BatchNormalization()(x)
    x = Dropout(0.3)(x)
    x = Dense(64, kernel_initializer=HeNormal(), kernel_regularizer=l2(0.01))(x)
    x = BatchNormalization()(x)
    x = Dropout(0.3)(x)
